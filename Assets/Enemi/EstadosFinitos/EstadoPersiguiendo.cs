...
public class EstadoPersiguiendo : EstadosFinitos
{
    ...
    public override Type VerficarTransiciones()
    {
        ...
        if (!e.pacman.GetComponent<ControladorScore>().estaVivo)
        {
    ...
    public override void Update()
    {
        ...
        //buscamos el multiplicador de nivel
        int nivel = 1;
        ...
        GetComponent<Rigidbody2D>().velocity = direccion * nivel;
        VerificarCambios();
    }
    ...
    public override Vector2 GetCardinalidad()
    {
