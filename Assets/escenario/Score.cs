...
public class Score
{
    ...
    {
        string uri = endPoint_api + "score/best/pacman";
    ...
    {
        string ednPoint_top = endPoint_api+"score/best/pacman";
    ...
    {
        WebRequest request = WebRequest.Create(endPoint_api+ "guardarData/pacman");
        request.Method = "POST";
